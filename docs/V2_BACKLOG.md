...
- Centered the active-mode date, tightened AM/PM vertical placement, and enlarged the metric rings while reducing metric value text so it fits inside the circles.
